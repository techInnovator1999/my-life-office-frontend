        ...
        <div className="flex h-full w-full flex-col overflow-y-auto no-scrollbar">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                          We've sent a verification code to <strong>{form.watch('email')}</strong>. Please enter the code below to verify your email address.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="px-8 pb-8 pt-4 lg:px-12 text-center lg:text-left">
            <p className="text-sm text-neutral-500 dark:text-neutral-400">
              ...
              <Link href="/signup" className="font-bold text-primary hover:text-primary/80 hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
